...
export class AuthService {
  ...
  baseUrl:string = "https://api-taneresidence.requestumdemo.com/oauth2/token";
  credentials: string;
  basic:string;
  ...
  postData(user: User){
    ...
    const body = { grant_type: user.grant_type, client_id: user.client_id, client_secret: user.client_secret, username: user.username, password: user.password};
  ...
  //     })
  //   }
  //   return this.http.post<User>(this.baseUrl, {grant_type: user.grant_type, client_id: user.client_id, client_secret: user.client_secret, username: user.username, password: user.password}, opt)
  ...
  public checkToken(){
    if (  ( localStorage.getItem("authData") != null ) || ( sessionStorage.getItem("authData") != null ) || ( localStorage.getItem("authData") != null && sessionStorage.getItem("authData") != null) ) {
      return true;
    }
    else return false
  }
