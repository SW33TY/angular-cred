...
export class HomeComponent implements OnInit, OnDestroy {
  ...
  async assignData() {
    const usersArr = await this.udService.getAllDatas()
      .then(data => {
  ...
  getData() {
    ...
    this.http
      .get('https://api-taneresidence.requestumdemo.com/api/' +
        'users/5/accountings?page=1&per-page=20&order-by=date%7Cdesc&expand=contact,paymentMethod,unit.property,account')
...
// getData(){
//   this.http
//     .get('https://api-taneresidence.requestumdemo.com/api/users/5/ +
//     accountings?page=1&per-page=20&order-by=date%7Cdesc&expand=contact,paymentMethod,unit.property,account')
//     .subscribe((data:El) => this.el=data);
//     console.log(this.el);
// }
